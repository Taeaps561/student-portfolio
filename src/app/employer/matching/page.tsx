...
const CANDIDATES_DATA: Candidate[] = [
  {
    ...
    matchScore: 98,
    verifiedSkills: ["Next.js", "React", "DevSecOps", "TypeScript"],
    bio: "นักศึกษาภาควิชาวิทยาการคอมพิวเตอร์ มสด. สนใจด้าน Full-Stack Dev & DevSecOps มีผลงานโครงงานระบบและใบรับรอง SHA-256 ครบครัน",
    experienceLevel: "ระดับสูง (5/5 ใน Next.js & DevSecOps)",
    isOpenToWork: true,
  },
  {
    id: "mock-somchai",
  ...
  },
  {
    ...
    matchScore: 92,
    verifiedSkills: ["Docker", "Kubernetes", "Linux Server", "DevOps"],
    bio: "มุ่งมั่นในการออกแบบ Cloud Infrastructure, Kubernetes และ Automated CI/CD Pipelines ได้รับวุฒิบัตร CKA สากล",
    experienceLevel: "ระดับสูง (5/5 ใน Docker & Linux)",
    isOpenToWork: true,
  },
  {
    id: "mock-saifah",
  ...
  },
  {
    ...
    matchScore: 89,
    verifiedSkills: ["React Native", "TypeScript", "REST API", "Mobile"],
    bio: "นักพัฒนา Mobile Application และ Cross-platform ด้วย Flutter & React Native เชื่อมโยงระบบหลังบ้านเสร็จสมบูรณ์",
    experienceLevel: "ระดับกลาง-สูง (5/5 ใน React Native)",
    isOpenToWork: true,
  },
  {
    id: "mock-jane",
  ...
  },
  {
    ...
    matchScore: 91,
    verifiedSkills: ["Python", "SQL & Analytics", "PowerBI", "Machine Learning"],
    bio: "นักศึกษาที่มุ่งเน้นการวิเคราะห์ข้อมูลขนาดใหญ่และ Machine Learning เพื่อธุรกิจ มีผลงานโมเดลคาดการณ์เชิงสถิติ",
    experienceLevel: "ระดับสูง (5/5 ใน Python & SQL)",
    isOpenToWork: true,
  },
];
